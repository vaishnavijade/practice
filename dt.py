...
Description:
In this exercise, you will explore the j of Gini Impurity and its role in 
...
class DecisionTreeClassifierGini:
    ...
    def calculate_gini_split(self, y, left_indices, right_indices):
        ...
        return gini
#This find_best_split method determines the best feature and threshold to split the dataset in order to minimize the Gini Impurity
